...
/*** Level 3 of the game*/
public class GameLevels3 extends GameLevels {
    ...
    public void populate(Game game) {
        ...
        troll.addCollisionListener(new Troll1Collision(game, game.getPlayer(),this));


        Troll1 trol2 = new Troll1(this);
        trol2.setPosition(new Vec2(-37.3f, 16f));
        trol2.addCollisionListener(new Troll2Collision(game, game.getPlayer(),this));

        background = new ImageIcon("data/Game_Parts/Images/UserView/Background/background3.png").getImage();
    ...
    @Override
    public Vec2 goblinPosition() { return new Vec2(-42.346233f,-5); }
